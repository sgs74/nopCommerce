...
namespace Nop.Services.ScheduleTasks
{
    ...
    public partial class ScheduleTaskRunner : IScheduleTaskRunner
    {
        ...
        /// </summary>
        protected void ExecuteTask(Core.Domain.Tasks.ScheduleTask scheduleTask)
        {
        ...
        protected virtual bool IsTaskAlreadyRunning(Core.Domain.Tasks.ScheduleTask scheduleTask)
        {
        ...
        public async Task ExecuteAsync(Core.Domain.Tasks.ScheduleTask scheduleTask, bool forceRun = false, bool throwException = false, bool ensureRunOncePerPeriod = true)
        {
